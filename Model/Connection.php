...
require_once __DIR__ . '/MysqlConn/PDOConn.php';
...
/*
$db = new Connection();
var_dump($db->query_all('select * from goods where gid = ?',[33]));
var_dump($db->query_one('select * from goods'));
var_dump($db->query_value('select gname from goods'));
var_dump($db->insert_into('goods', ['gname','price'], [['qw','123'],['as', '456']]));*/
